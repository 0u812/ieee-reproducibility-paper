...
\subsection{Reproducibility vs Replicability}
...
a result which is exactly identical across implementations, compliance with the standard often
...
the output of the simulator is a replica of the original.
