...
\begin{figure*}
  ...
  \begin{subfigure}[b]{0.5\textwidth}
    ...
    \]
    \[
      K_m = 10^6\,\textrm{$\mu$M, and}
    \]
    \[
      k = 0.125\,\textrm{$\mu$M\,s$^{-1}$}.
    \]
    \vspace{1em}
  \end{subfigure}%
  \begin{subfigure}[b]{0.5\textwidth}
...
Parallel shared-memory time step simulations can be made deterministic by synchronizing the end of time steps with barriers \cite{brooks1986butterfly}, such as implemented in OpenMP \cite{dagum1998openmp}, and employing deterministic approaches to share time step state updates among threads.
