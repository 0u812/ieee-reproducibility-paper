...
We view WholeCellKB-MG as an important step in the right direction, but, we also suggest
ways in which whole-cell databases could be better implemented.
In particular, we think that a user-centric design for such databases is a must,
and that future research should focus on user interaction with these resources.
...
recorded in an easily accessible way, and all of this information must be
presented in a way that allows efficient searching, displaying, and accessing.
...
easy to search and browse, the details of how the data was used to parameterize the model are not fully transparent
...
The problem of transparency and documentation quality has been present in quantitative modeling for some time. The SBML community's response to this problem was MIRIAM:
...
The whole-cell model coordinates this synchronization and partitions resources such as cellular energy stores
among the submodels.
