...
\caption{Core requirements for reproducibility vs. replicability.}
...
First, the theoretical formulation of the model must be well-understood.
...
Second, the numerical algorithms used by the simulator must converge on a solution.
...
However, despite these advances, reproducibility in dynamical modeling remains a challenge \cite{garijo2013quantifying}.
