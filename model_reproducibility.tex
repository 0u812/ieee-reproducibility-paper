...
The \textit{M. genitalium} whole-cell model \hl{[Karr2012]} consists of
28 submodels.
...
(etc. ODEs, Boolean networks, and flux balance analysis) \hl{[CovertReview]}.
...
Standardization of the \textit{M. genitalium} whole-cell model \hl{[Karr2012]}
...
580k base pairs \hl{[replace exact count?]}, overwhelms most SBML
simulators.
